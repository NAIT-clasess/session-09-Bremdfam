...
public class Pong : Game
{
    ...
    #region Second Paddle properties
    private Vector2 _SecondPaddlePosition, _SecondPaddleDirection, _SecondPaddleDimensions;
    Rectangle _SecondPaddleRect => new Rectangle((int)_SecondPaddlePosition.X, (int)_SecondPaddlePosition.Y, _paddleWidth, _paddleHeight);
    #endregion
    ...
    protected override void Initialize()
    {
        ...
        _SecondPaddlePosition = new Vector2(60, 198);
        _SecondPaddleDirection = Vector2.Zero;
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        {
            _SecondPaddleDirection = new Vector2(0, -1);
        }
        ...
        _SecondPaddlePosition += _SecondPaddleDirection * _paddleSpeed * dt;

        // --- Clamping for Left Paddle ---
        if (_SecondPaddlePosition.Y <= _playAreaBoundingBox.Top)
        {
            _SecondPaddlePosition.Y = _playAreaBoundingBox.Top;
        }
        else if (_SecondPaddlePosition.Y + _SecondPaddleDimensions.Y >= _playAreaBoundingBox.Bottom)
        {
            _SecondPaddlePosition.Y = _playAreaBoundingBox.Bottom - _SecondPaddleDimensions.Y;
        }
        _ballPosition += _ballDirection * _ballSpeed * (float)gameTime.ElapsedGameTime.TotalSeconds;
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        // Draw both paddles
        _spriteBatch.Draw(_paddleTexture, _paddleRect, Color.White); // Right
        _spriteBatch.Draw(_paddleTexture, _SecondPaddleRect, Color.White); // Left
